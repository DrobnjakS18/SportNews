        ...
        <td align="center">
            <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                    <td align="center">
                        <a href="{{route('home')}}">
                            <img src="{{asset('images/logos/logo.png')}}" width="169" alt="Unlimited3D">
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="body" width="100%" cellpadding="0" cellspacing="0">
                        <table class="inner-body" align="center" width="520" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                <hr>
                                <td class="content-cell" align="center"><h4><font face="Montserrat, sans-serif">New Post By - autor</font></h4></td>
                            </tr>
                            <tr>
                                <td class="content-cell" align="center"><h1><font face="Montserrat, sans-serif">Naslov</font></h1></td>
                            </tr>
...
{{--                            </tr>--}}
                            <tr>
                                <td class="content-cell" align="center"><p class="thanks_congrats" align="center">Tekst</p></td>
                            </tr>
                            <tr>
