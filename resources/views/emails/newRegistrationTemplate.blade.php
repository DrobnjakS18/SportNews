                        ...
                        <table class="inner-body" align="center" width="420" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                <td class="content-cell" align="center">
                                    <hr>
                                    <h4><font face="Montserrat, sans-serif">New user registered</font></h4>
                                    <h4><font face="Montserrat, sans-serif">Username:  {{ $username ?? '' }}</font></h4>
                                    <h4><font face="Montserrat, sans-serif">Email:  {{ $email ?? '' }}</font></h4>
                                </td>
                            </tr>
                            <tr>
                                <td class="content-cell" align="center">
