...
@section('content')
                    ...
                    <div class="author-block">
                        ...
                        <div class="author-content">
                            ...
                            <div class="author-options text-center mt-5">
                                ...
                                <a class="author-edit-post" href="#">Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {{--                                PROMENITI PROFILNU SLIKU U SLIKU POSTA--}}
                                    <img class="img-fluid" src="{{asset('images/'.$items->user->profile_picture)}}" alt="post-thumbnail">
                                </div>
