                            ...
                            @if($items->comments->count() > 0)
                                @foreach($items->comments->where('status','verified') as $comment)
                                    @if($comment->comment_id == null)
                                        <li>
                                            <div class="comment">
                                                <img class="commented-person" alt="Sport News profile image" src="{{$comment->user->profile_picture}}">
                                            ...
                                            @foreach($comment->replies as $reply)
                                                @if($reply->comment_id !== null && $reply->comment_id === $comment->id)
                                                    <ul class="comments-reply">
                                                        <li>
                                                            <div class="comment">
                                                                <img class="commented-person img-fluid" alt="Sport News profile image" src="{{$reply->user->profile_picture}}">
                                                                <div class="comment-body">
                                                                    <div class="meta-data">
